        ...
        public class Coordinates
        {
            ...
            public string GetCoord(string PlayerID)
            {
                ...
                switch (type)
                {
                    ...
                    case 2:
                        return $"X: {player.transform.position.x.ToString("0")} | Z: {player.transform.position.z.ToString("0")} | {FormatGridReference(player.ServerPosition)}";
                    default:
                        return FormatGridReference(player.ServerPosition);
